...
interbancaria."
    ...
    move_down 20
    txt ="Por lo anteriormente expuesto y fundado, se propone a #{justificacion.proveedor_uno} con domicilio en #{justificacion.domicilio} \f
, Registro Federal de Contribuyentes <i>#{justificacion.rfc}</i> bajo el Régimen General de Ley Personas Morales."
    txt = txt.gsub(/\f\n/, '')
    text txt, :align=>:justify, :inline_format => true
